...
// SuperintendentDashboard component: Displays dashboard analytics and notifications for Superintendent
const SuperintendentDashboard = () => {
  ...
  // Fetch notifications pending for Superintendent (notifyprincipal: true, notifyhoo: true, notifysi: false)
  useEffect(() => {
