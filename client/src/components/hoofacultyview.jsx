      ...
      <div className="asset-view">
        ...
        <section id="sidebar">
          ...
          <ul className="side-menu top">
            ...
            <li className="active"><a href={`/hoofacultyview?username=${encodeURIComponent(username)}`}><i className="bx bxs-doughnut-chart" /><span className="text">Faculty View</span></a></li>
          </ul>
