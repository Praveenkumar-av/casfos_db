...
// PrincipalDashboard component: Displays analytics and notifications for the Principal
const PrincipalDashboard = () => {
  ...
  const [selectedYear, setSelectedYear] = useState("All"); // Selected year for asset charts
  ...
  const [selectedLocation, setSelectedLocation] = useState("All"); // Selected location for permanent assets
  ...
  // User role data for display (unused in charts but defined in original code)
  const salesData = [
                  ...
                  >
                    <div style={styles.notificationSummary}>
                      <span style={styles.notificationTitle}>
                        ...
                        <span style={styles.notificationTime}>{new Date(notification.actionTime).toLocaleString()}</span>
                      </span>
                      <div>
                        <button style={styles.expandButton} onClick={() => toggleExpand(notification._id)}>
                          {expandedNotification === notification._id ? "▲" : "▼"}
                        </button>
                        <button style={styles.clearButton} onClick={() => handleClearNotification(notification._id)}>
                          ×
                        </button>
                      </div>
                    </div>
