      ...
      const fetchIssuedLocations = async () => {
        try {
          const response = await axios.post(
            "http://localhost:3001/api/assets/getIssuedLocations",
            {
              assetType,
              assetCategory,
              itemName,
  ...
  useEffect(() => {
    if (assetType && assetCategory) {
      const fetchStoreItems = async () => {
        try {
          const response = await axios.post(
            "http://localhost:3001/api/assets/getStoreItems",
  ...
  useEffect(() => {
    if (assetType && assetCategory && selectedItem && returnItem.location) {
      ...
      const fetchIssuedData = async () => {
        try {
          const response = await axios.post(
            "http://localhost:3001/api/assets/getIssuedIds",
            {
              assetType,
              assetCategory,
              itemName,
      ...
      const fetchRejectedReturn = async () => {
        try {
          const response = await axios.get(
            `http://localhost:3001/api/assets/rejected-asset/${rejectedId}`
          );
