 ...
 * Notifications are fetched from a backend API at 'http://localhost:3001' for notifyprincipal: true, notifyhoo: true, notifysi: false, sorted by notificationDate, limited to 50.
 */
