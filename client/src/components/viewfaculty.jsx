      ...
      <div className="asset-view">
        ...
        <section id="sidebar">
          ...
          <ul className="side-menu top">
            <li ><a href={`/facultyentrystaffdashboard?username=${encodeURIComponent(username)}`}><i className="bx bxs-dashboard" /><span className="text">Home</span></a></li>
            ...
            <li className="active"><a href={`/viewfaculty?username=${encodeURIComponent(username)}`}><i className="bx bxs-doughnut-chart" /><span className="text">Faculty View</span></a></li>
          </ul>
