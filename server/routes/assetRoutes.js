...
router.get("/rejected-asset/:id", AssetController.getRejectedAsset);
router.delete("/rejected-asset/:id", AssetController.deleteRejectedAsset);
...
router.post('/updateReturnCondition/:id', AssetController.updateReturnCondition);
router.post('/updateReturnConditiontemp/:id', AssetController.updateReturnConditiontemp);
router.post("/submitForApproval", AssetController.submitForApproval);

// Route to fetch all pending updates (used by Asset Manager)
router.get("/pendingUpdates", AssetController.getPendingUpdates);
router.get("/rejectedUpdates", AssetController.getRejectedUpdates);

// Route to approve an update (used by Asset Manager)
router.post("/approveUpdate/:id", AssetController.approveUpdate);

router.post("/getBuildingUpgrades", AssetController.getBuildingUpgrades);
router.post("/addBuildingUpgrades", AssetController.addBuildingUpgrade);
// Route to reject an update (used by Asset Manager)
router.post("/rejectUpdate/:id", AssetController.rejectUpdate);
...
router.delete("/delete-all-asset-notification", AssetController.deleteAllAssetNotifications);

router.get("/getReturnedForConditionChange", AssetController.getReturnedForConditionChange);

// Get all temporary building upgrades
router.get('/getTempBuildingUpgrades', AssetController.getTempBuildingUpgrades);

// Approve building upgrade
router.post('/approveBuildingUpgrade/:id', AssetController.approveBuildingUpgrade);
router.post('/rejectBuildingUpgrade/:id', AssetController.rejectBuildingUpgrade); // New route

router.post("/updateDeadStockQuantities",AssetController.updateDeadStockQuantities);
router.post("/filterDeadStock", AssetController.filterDeadStock);

router.post("/saveMaintenanceTemp", AssetController.saveMaintenanceTemp);
router.get("/getPendingMaintenance", AssetController.getPendingMaintenance);
router.post("/approveOrRejectMaintenance", AssetController.approveOrRejectMaintenance);
