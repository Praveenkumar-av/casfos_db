...
function storekeeperAssetUpdation() {
...
useEffect(() => {
  ...
  const clearRejectedUpdate = () => {
    ...
    window.history.replaceState(null, "", `/storekeeperassetupdation?username=${encodeURIComponent(username)}`);
  };
    ...
    <div className="asset-updation">
      ...
      <section id="sidebar">
          ...
          <ul className="side-menu top">
            ...
            <li className="active"><a href={`/storekeeperassetupdation?username=${encodeURIComponent(username)}`}><i className="bx bxs-reply" /><span className="text">Asset Updation</span></a></li>
